...
namespace DBManager.Scanning.XMLDataClasses
{
	...
	public class CCompSettings : CXMLSerializerBase
	{
		...
		#region CompName
		string m_CompName = GlobalDefines.DEFAULT_XML_STRING_VAL;
		...
		string m_SecondColName = GlobalDefines.DEFAULT_XML_STRING_VAL;
		[XmlAttribute()]
		[DefaultValue(GlobalDefines.DEFAULT_XML_STRING_VAL)]
		...
		#region MainJudge
		string m_MainJudge = GlobalDefines.DEFAULT_XML_STRING_VAL;
		[XmlAttribute()]
		[DefaultValue(GlobalDefines.DEFAULT_XML_STRING_VAL)]
		...
		string m_MainSecretary = GlobalDefines.DEFAULT_XML_STRING_VAL;
		[XmlAttribute()]
		[DefaultValue(GlobalDefines.DEFAULT_XML_STRING_VAL)]
		...
		#region Row6
		string m_Row6 = GlobalDefines.DEFAULT_XML_STRING_VAL;
		[XmlAttribute()]
		[DefaultValue(GlobalDefines.DEFAULT_XML_STRING_VAL)]
		public string Row6
		{
		...
		byte m_MembersFrom1stQualif = GlobalDefines.DEFAULT_XML_BYTE_VAL;
		...
		byte m_MembersFrom2ndQualif = GlobalDefines.DEFAULT_XML_BYTE_VAL;
		...
		#region QualifDate
		string m_QualifDate = GlobalDefines.DEFAULT_XML_STRING_VAL;
		...
		string m_OneEighthFinalDate = GlobalDefines.DEFAULT_XML_STRING_VAL;
		...
		string m_QuaterFinalDate = GlobalDefines.DEFAULT_XML_STRING_VAL;
		...
		string m_SemiFinalDate = GlobalDefines.DEFAULT_XML_STRING_VAL;
		...
		#region FinalDate
		string m_FinalDate = GlobalDefines.DEFAULT_XML_STRING_VAL;
		...
		enSecondColNameType m_SecondColNameType = enSecondColNameType.None;
		/// <summary>
		/// Тип второй колонки.
