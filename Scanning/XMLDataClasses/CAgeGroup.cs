...
namespace DBManager.Scanning.XMLDataClasses
{
    ...
    public class CAgeGroup : CXMLSerializerBase
    {
        ...
        private int m_StartYear = GlobalDefines.DEFAULT_XML_INT_VAL;
        [XmlAttribute]
        ...
        private string m_EndYear = GlobalDefines.DEFAULT_XML_STRING_VAL;
        [XmlAttribute]
        [DefaultValue(GlobalDefines.DEFAULT_XML_STRING_VAL)]
        ...
        private byte m_Sex = GlobalDefines.DEFAULT_XML_BYTE_VAL;
        [XmlAttribute]
        ...
        private enGroupType m_GroupType = enGroupType.None;
        /// <summary>
        /// Тип группы.
        ...
        private short m_wEndYear = GlobalDefines.DEFAULT_XML_INT_VAL;
        /// <summary>
