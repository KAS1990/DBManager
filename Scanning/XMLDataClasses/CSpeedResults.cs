...
namespace DBManager.Scanning.XMLDataClasses
{
    ...
    public class CSpeedResults : CXMLSerializerBase, IXmlSerializable
    {
        ...
        private readonly XmlSerializer MemberSerializer = new XmlSerializer(typeof(CMember));
        #endregion

        private string m_NodeName = GlobalDefines.DEFAULT_XML_STRING_VAL;
        /// <summary>
        ...
        private readonly Dictionary<string, object> m_DefaultValues = new Dictionary<string, object>();
