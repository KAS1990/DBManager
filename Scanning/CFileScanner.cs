...
namespace DBManager.Scanning
{
    ...
    public class CFileScanner : CScannerBase
    {
        ...
        private CGroupResultsManager m_ResultsManager = null;
        ...
        /// </summary>
        private readonly CXMLDataSerializer m_XMLDataSer = new CXMLDataSerializer();


        #region DataFromXml
        private CAllExcelData m_DataFromXml = null;
