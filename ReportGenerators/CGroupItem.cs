...
namespace DBManager.Excel.Exporting.Tabs
{
	public class CGroupItem : INotifyPropertyChanged
	{
		...
		#region Rounds
		private ObservableCollection<CRoundItem> m_Rounds = new ObservableCollection<CRoundItem>();
		...
		private List<int> m_YearsOfBirth = new List<int>();
		...
		void Round_PropertyChanged(object sender, PropertyChangedEventArgs e)
		{
