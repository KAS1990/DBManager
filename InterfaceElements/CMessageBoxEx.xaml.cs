...
namespace DBManager.Stuff
{
    ...
    public partial class CMessageBoxEx : Window
    {
        ...
        /// </summary>
        private bool m_DisableCloseButton = false;
        private readonly Button[] AddedStdButtons = null;
        ...
        /// </param>
        private void AddAdditionalButons(string[] AdditionalButonsTexts, int DefaultAdditionalButton)
        {
        ...
        /// </param>
        private Button[] AddStdButtons(MessageBoxButton MsgKind, MessageBoxResult DefaultButton)
        {
            Button[] result = null;
        ...
        private Button AddStdButton(MessageBoxResult ButtonKind, MessageBoxResult DefaultButton)
        {
            Button btn = new Button()
            {
