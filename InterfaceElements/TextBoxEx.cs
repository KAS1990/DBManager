...
namespace DBManager.InterfaceElements
{
	...
	public class TextBoxEx : TextBox, IVisBaseElement
	{
		...
		bool m_PressedCancelButton = false;
		/// <summary>
		...
		Brush m_ErrorColor = Brushes.Red;
		/// <summary>
		...
		Thickness m_ErrorBorderThickness = new Thickness(2);
		/// <summary>
		/// Цвет фона елемента, если в него ввели неверные данные
		/// </summary>
		...
		PointI m_ElementCoords = new PointI(-1, -1);
		...
		string m_ErrorMsgResString = STD_ERROR_MSG_RES_STRING;
		/// <summary>
		...
		string m_ErrorMsgResStringWithRowNum = STD_ERROR_MSG_RES_STRING_WITH_ROW_NUM;
		/// <summary>
		/// Идентификатор строки из ресурсов,
		/// которая используется для показа сообщения, если !ElementCoords.IsEmpty()
		...
		bool m_ReturnPrevValOnErrInput = false;
		/// <summary>
		...
		enCaclValueResult m_InputCheckResult = enCaclValueResult.NoError;
		/// <summary>
		...
		/// </param>
		void OnErrorInput(bool ShowErrMsg)
		{
