...
namespace DBManager.Excel.Exporting.ExportingClasses
{
    public class CTeamExporter : CReportExporterBase
    {
        ...
        private readonly int EXCEL_TEAM_COL_NUM = 2;
        private readonly int EXCEL_TEAM_MEMBERS_OFS = 0;
        private readonly int EXCEL_TEAM_BALLS_OFS = 1;
        #endregion
