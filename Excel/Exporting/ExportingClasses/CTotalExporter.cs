...
namespace DBManager.Excel.Exporting.ExportingClasses
{
    public class CTotalExporter : CReportExporterBase
    {
        ...
        private readonly int EXCEL_ROUTE1_COL_OFS = 1;
        private readonly int EXCEL_ROUTE2_COL_OFS = 2;
        private readonly int EXCEL_SUM_COL_OFS = 3;
        #endregion
